# External datasets: MTSD and CURE-TSD

This project may add two large external sources, but neither replaces the
...
`configs/external_datasets_v1.json`.  The MTSD research-use license does not
...
```bash
cd /home/ubuntu/Dung_TDTU/nighttime-tsd-new && mkdir -p ../nighttime-tsd/data/raw/MTSD/incoming ../nighttime-tsd/data/raw/MTSD/release ../nighttime-tsd/data/raw/MTSD/checksums ../nighttime-tsd/data/raw/CURE-TSD/incoming ../nighttime-tsd/data/raw/CURE-TSD/release ../nighttime-tsd/data/raw/CURE-TSD/checksums
```

Download the official archive manually after accepting the corresponding
terms.  Place it in the relevant `incoming/` directory.  Do not use an
unofficial mirror, Kaggle repackaging, or a scraped image set for this paper.
